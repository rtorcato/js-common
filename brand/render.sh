...
rsvg-convert -w 1280 -h 320 brand/banner.svg        -o banner.png
rsvg-convert -w 1280 -h 786 brand/banner-mobile.svg -o banner-mobile.png
...
echo "rendered: banner.png banner-mobile.png social-card.png favicon-512.png"
